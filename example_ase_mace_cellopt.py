...
supercell222.calc = MACECalculator(model_paths="/scratch/group/p.cis240698.000/xyan11/workdir/calf-20/mace-mof/model_cache/mofs_v1.model", device="cuda")
#supercell222.calc = MACECalculator(model_paths="/scratch/group/p.cis240698.000/xyan11/workdir/calf-20/mace-mof/model_cache/mofs_v2.model", device="cuda")
